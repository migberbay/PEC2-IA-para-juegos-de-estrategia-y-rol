...
public class NVBoids : MonoBehaviour
{
    ...
    void BirdsMove()
    {
        ...
        for (int b = 0; b < birdsNum; b++)
        {
            ...
            // added this check in case the transform has been removed (eaten)
            if(birdsTransform[b] != null)
            {
    ...
    IEnumerator Danger()
    {
        ...
        if (danger == true)
        {
            ...
            while (true)
            {
                ...
                if (birdsTransform[dangerBird] != null)
    ...
    void CreateBird()
    {
        ...
        for (int b = 0; b < birdsNum; b++)
        {
            ...
            // Reference to the manager on creation:
            birdsTransform[b].GetComponent<OnDestroyBoid>().manager = this;
    ...
    public void AddNewBird()
    {
        ...
        Debug.Log("Add a new bird to the scene.");
    }
